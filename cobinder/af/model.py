...
from cobinder.af.alphafold.model import data, config, model, all_atom

from cobinder.shared.model import design_model
from cobinder.shared.utils import Key

from cobinder.af.prep   import _af_prep
from cobinder.af.loss   import _af_loss, get_plddt, get_pae, get_ptm
from cobinder.af.loss   import get_contact_map, get_seq_ent_loss, get_mlm_loss
from cobinder.af.utils  import _af_utils
from cobinder.af.design import _af_design
from cobinder.af.inputs import _af_inputs, update_seq, update_aatype
...
class mk_af_model(design_model, _af_inputs, _af_loss, _af_prep, _af_design, _af_utils):
  ...
  def _get_model(self, cfg, callback=None):
    ...
    def _model(params, model_params, inputs, key):
      def forward(params, model_params, inputs, key):
        ...
        return loss, aux
      loss,aux = forward(params, model_params, inputs, key)
      return loss, aux
