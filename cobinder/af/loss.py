...
from cobinder.shared.utils import Key, copy_dict
from cobinder.shared.protein import jnp_rmsd_w, _np_kabsch, _np_rmsd, _np_get_6D_loss
from cobinder.af.alphafold.model import model, folding, all_atom
from cobinder.af.alphafold.common import confidence_jax, residue_constants
...
class _af_loss:
  ...
  def _loss_binder2(self, inputs, outputs, aux):
    self._loss_binder(self, inputs[0], outputs, aux)
