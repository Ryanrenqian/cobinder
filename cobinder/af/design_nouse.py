...
class _af_design:
  ...
  def run(self, num_recycles=None, num_models=None, sample_models=None, models=None,
    ...
    if self.protocol in ["fixbb","partial"] or (self.protocol in ["binder","binder2"] and self._args["redesign"]):
